...
var ToptoonAnalyzer_1 = __importDefault(require("./analyzer/ToptoonAnalyzer"));
var Crawler = /** @class */ (function () {
    ...
    Crawler.prototype.initCrawler = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        return [4 /*yield*/, this.analyzer.analyze(html, this.filePath)];
                    case 2:
                        fileContent = _a.sent();
